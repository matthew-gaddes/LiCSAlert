...
def licsalert_results_explorer(licsalert_dir, fig_width = 18):
    """ The interactive figure for exploring LiCSAlert results.
    
    Inputs:
        licsalert_dir | pathlib Path | path to directory of LiCSAlert results.   e.g. Path("./../001_campi_flegrei_example")
